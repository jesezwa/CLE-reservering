...
// Specifieke datum instellen met DateTime
$gewensteDatum = new DateTime("2024-01-16");

// Weergave van de gekozen datum
echo "Gekozen datum: " . $gewensteDatum->format("Y-m-d");
